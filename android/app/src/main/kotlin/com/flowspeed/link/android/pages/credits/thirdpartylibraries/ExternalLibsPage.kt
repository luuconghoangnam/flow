package com.flowspeed.link.android.pages.credits.thirdpartylibraries
...
import com.flowspeed.link.android.ui.page.FooterFade
import com.flowspeed.link.android.ui.page.HeaderFade
...
private fun rememberLibs(): Libs {
    ...
    return remember {
        val jsonContent = resources
            .openRawResource(com.flowspeed.link.android.R.raw.aboutlibraries)
            .bufferedReader()
            .use { it.readText() }
