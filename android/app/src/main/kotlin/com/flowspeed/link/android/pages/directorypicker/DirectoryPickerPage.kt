package com.flowspeed.link.android.pages.directorypicker
...
import com.flowspeed.link.android.ui.SheetTitleWithDescription
import com.flowspeed.link.android.ui.SheetUI
import com.flowspeed.link.android.ui.configurable.RenderSpinnerInSheet
...
import com.flowspeed.link.shared.ui.widget.IconActionButton
...
import com.flowspeed.link.shared.util.ui.VerticalScrollableContent
...
import com.flowspeed.lib.util.PathValidator
...
import com.flowspeed.lib.util.createDirectories
import com.flowspeed.lib.util.exists
import com.flowspeed.lib.util.isDirectory
import com.flowspeed.lib.util.listFiles
import com.flowspeed.lib.util.listFilesOrNull
import com.flowspeed.lib.util.startsWith
...
fun DirectoryPicker(
    ...
    ResponsiveDialog(
        ...
        val storagePermissionState = rememberAppPermissionState(FlowPermissions.StoragePermission)
