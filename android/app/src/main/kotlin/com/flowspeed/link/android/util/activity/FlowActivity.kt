...
import com.flowspeed.link.android.ui.FlowApplicationContent
...
abstract class FlowActivity : ComponentActivity(), KoinComponent {
    ...
    val FlowAppManager: FlowAppManager by inject()
    ...
    override fun onStart() {
        super.onStart()
        FlowAppManager.bootDownloadSystemAndService()
    }
