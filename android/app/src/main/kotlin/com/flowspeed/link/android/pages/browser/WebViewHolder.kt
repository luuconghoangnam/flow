...
import com.flowspeed.link.android.ui.widget.AccompanistWebChromeClient
import com.flowspeed.link.android.ui.widget.AccompanistWebViewClient
import com.flowspeed.link.android.ui.widget.WebContent
import com.flowspeed.link.android.ui.widget.WebViewNavigator
...
class WebViewRegistry(
    ...
    val viewHolders = mutableMapOf<FlowBrowserTabId, WebViewHolder>()
    fun onTabsUpdated(
        webViewStates: FlowTabs,
    ) {
    ...
    fun getWebViewHolder(
        ...
        return viewHolders.getOrPut(tab.tabId, {
            WebViewHolder(
                ...
                webView = null,
                client = FlowWebViewClient(browserComponent.downloadInterceptor, scope),
                chromeClient = FlowChromeClient(browserComponent, ::getWebViewHolder),
                webViewFactory = this,
            )
        })
    }
    ...
    override fun createWebView(
        ...
        return FlowWebView(context).apply {
            val webView = this
...
data class WebViewHolder(
    val tab: FlowBrowserTab,
    var webView: FlowWebView? = null,
    val navigator: WebViewNavigator,
    val client: FlowWebViewClient,
    val chromeClient: FlowChromeClient,
    private val webViewFactory: WebViewFactory,
) {

    fun activate(context: Context): FlowWebView {
...
class FlowChromeClient(
    private val browserComponent: BrowserComponent,
    private val createWebViewHolder: (tab: FlowBrowserTab) -> WebViewHolder,
    ...
    override fun onCreateWindow(
        ...
        val newTab = browserComponent.newTab(
            ...
            switch = true,
            url = null,
            openedBy = (view as? FlowWebView)?.tabId
        )
