...
import com.flowspeed.link.android.pages.browser.bookmark.EditBookmarkState
...
class BrowserComponent(
    ...
    fun newTab(
        url: String? = FlowBrowserTab.blankPage,
        switch: Boolean = true,
        id: String = UUID.randomUUID().toString(),
        openedBy: FlowBrowserTabId? = null,
    ): FlowBrowserTab {
        val browserTab = FlowBrowserTab(
            tabId = id,
    ...
    fun closeTab(tabId: FlowBrowserTabId) {
        tabs.update {
    ...
    fun switchTab(tabId: FlowBrowserTabId) {
        tabs.update {
    ...
    fun createCloseTabAction(tab: FlowBrowserTab): AnAction {
        return simpleAction(
...
typealias FlowBrowserTabId = String

@Stable
data class FlowBrowserTab(
    val tabId: FlowBrowserTabId,
...
data class FlowTabs(
    ...
    companion object {
        fun createDefault(): FlowTabs = FlowTabs(
            listOf(),
            -1,
        )
    }
