...
val ourPackageName = "com.flowspeed.link.resources"
val propertiesToKotlinTask by tasks.registering(PropertiesToKotlinTask::class) {
    ...
    myStringResourceClass.set("com.flowspeed.lib.resources.contracts.MyStringResource")
    propertyFiles.from("src/commonMain/resources/com/flowspeed/link/resources/locales/en_US.properties")
}
...
android {
    compileSdk = 36
    namespace = "com.flowspeed.link.resources"
    defaultConfig {
        minSdk = 26
    }
